...
/**
 * Side Projects Selection Grid - 3 clickable project folders
 * Click to view detailed project information with papers
 */
interface SideProjectsSelectionProps {
  onProjectSelect: (project: 'popuptrivia' | 'vibelink' | 'graphibooks') => void;
}
...
export const SideProjectsSelection = ({ onProjectSelect }: SideProjectsSelectionProps) => {
  ...
  return (
    <>
      ...
      {/* Folder 3 - GraphiBooks (Bottom Center) */}
      <group
        position={[0, -1.5, 0.04]}
        onClick={(e) => {
          e.stopPropagation();
